...
func loadConfig() (Config, error) {
	...
	if cfg.TelegramAppID == 0 || cfg.TelegramAppHash == "" {
		return Config{}, fmt.Errorf("missing Telegram credentials: set telegram_app_id and telegram_app_hash in %s or via TELEGRAM_APP_ID/TELEGRAM_APP_HASH", configPath)
	}
